...
train_files = glob.glob("..\\..\\Sony_small\\Sony_small\\Sony\\short\\0*_00_0.1s.ARW")

train_files +=glob.glob("..\\..\\Sony_small\\Sony_small\\Sony\\short\\2*_00_0.1s.ARW")


gt_files = []
for x in train_files:
    gt_files += glob.glob('..\\..\\Sony_small\\Sony_small\\Sony\\long\\*'+x[-17:-12]+'*.ARW')
...
test_files = glob.glob('..\\..\\Sony_small\\Sony_small\\Sony\\short\\1*_00_0.1s.ARW')
gt_files = []
for x in test_files:
    gt_files = gt_files+ glob.glob('..\\..\\Sony_small\\Sony_small\\Sony\\long\\*'+x[-17:-12]+'*.ARW')#NOTICE THIS IS THE SAME AS FOR THE TRAIN_FILES!! MISTAKE?
